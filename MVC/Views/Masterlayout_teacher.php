        ...
        <div class="row"> 
            <div class="menu_left1"> 
                <div class="list-group"> 
                    <a href="/Home/teacher" class="list-group-item "> 
                    ...
                    <span id="arrow" class="fas fa-chevron-down" style="float: right; margin-left: 10px;"></span> 
                            ...
                            <div id="submenuDetai" style="display: none; padding-left: 20px;">
                                <a href="/Detai/themmoi" class="list-group-item">Quản Lý Đề Tài</a>
                                <a href="/Detai/trangthaidetai" class="list-group-item">Trạng thái đề tài</a>
                            </div>
