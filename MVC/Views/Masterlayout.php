...
<body> 
    ...
    <a href="/thongtinnguoidung" id="userInfo" style="display: block; padding: 10px; text-decoration: none; color: black; font-size: 14px; border-bottom: 1px solid #e0e0e0;">Thông tin người dùng</a>
        ...
        <div class="row"> 
            <div class="menu_left1"> 
                <div class="list-group"> 
                    <a href="/Home/Get_data" class="list-group-item "> 
                    ...
                    <span id="arrow" class="fas fa-chevron-down" style="float: right; margin-left: 10px;"></span> 
                            ...
                            <div id="submenuDetai" style="display: none; padding-left: 20px;">
                                <a href="/Home/student" class="list-group-item">Quản Lý Sinh Viên</a>
                                <a href="/Home/teacher" class="list-group-item">Quản Lý Giáo Viên</a>
                            </div>
